...
\section*{Camera-ready todos}
\begin{itemize}
\item ``State major features of the formulation in comparison to existing models''.  That is - update text in comparison section
\item Validate basis $K$ (details in supp material)
\item Discuss updated basis fitting procedure - MCEM (in supp mat)
\item Better describe parameter domains and priors (details in supp mat)
\end{itemize}
...
\vskip -.16in
\begin{center}
\centerline{\includegraphics[width=.9\textwidth]{../figs/quasar_redshift_example}}
\vskip -.16in
\caption{%
...
{
  \hskip -.2in \includegraphics[width=.55\textwidth]{../figs/rank_4_basis-random}
}
