...
\end{align}
We fit this prior on the $\omega$ weights derived from the full spectroscopically measured dataset.  We determine the number of Gaussian components by comparing likelihoods value a held-out validation set.  
...
\begin{figure*}[t]
\vskip -.16in
\centerline{\includegraphics[width=\textwidth]{../figs/rank_4_basis}}
\centerline{\includegraphics[width=\textwidth]{../figs/idx_0_rank_4_reconstruction.pdf}}
