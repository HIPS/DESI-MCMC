...
of Gaussians. In theory, it suggests that there is some probability of negative fluxes in the bands,
which is physically impossible. Furthermore, the original method trains and tests the model
on a pre-specified range of $i$-magnitudes, which is problematic if we want to predict
