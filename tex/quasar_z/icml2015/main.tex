...
The black line marks the spectroscopically confirmed redshift, and the red line marks the posterior mean $E(z_n |\mathbf{X}, \mathbf{y}_n)$. 
\todo[inline]{Maybe mention that the x-axis of those histograms is super zoomed in?}
}
\label{fig:recon}
\vskip -0.1in
\end{figure*}
