...
respectively. $\mu_{j}\in\mathbb{R}^{2}$ denotes the position of source
$j$.
...
\hline 
$m$ & $\left(1-g\right)b_{j_{*}}$ & $-g b_{j_{*}}$ & $0$ & $0$ & 0 & 0\tabularnewline
\hline 
...
\todo{Do we want a closed-form of the determinant?}
...
b' \\
t'
\end{bmatrix}=h\left(\begin{bmatrix}u\\
t \\
b
\end{bmatrix}\right)=\begin{bmatrix}u\\
t \\
b
