...
\item The band-wise brightnesses
...
to be decided. The important thing for the reverse transition is to make the reverse transition from band-wise brightnesses
...
discard parameters (2) - (5), and apply the reverse $b_{giruz} \to (b_s, t_s)$ transformation.

\textbf{TODO}. Work out the reversible $b_{girl} \iff (b_s, t_s)$ transformations.
